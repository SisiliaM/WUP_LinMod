...
The anova test tells us that using both ARM and GRIP is a better model than just using GRIP. This is shown by the low p-value telling us that there is a small chance of getting these results if there was no difference between the models.
